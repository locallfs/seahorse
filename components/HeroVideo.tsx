      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <div className="mb-8 flex justify-center">
          <Image
            ...
            priority
            unoptimized
            className="w-full max-w-4xl h-auto drop-shadow-[0_0_8px_rgba(247,105,0,0.8)] [filter:drop-shadow(0_0_3px_rgba(247,105,0,0.9))_drop-shadow(0_0_12px_rgba(247,105,0,0.6))]"
          />
        </div>
